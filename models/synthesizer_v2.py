"""
RVC v2 Synthesizer Networks.
Implements SynthesizerTrnMs768NSFsid (with F0) and SynthesizerTrnMs768NSFsid_nono (without F0).
These use 768-dim HuBERT features from layer 12.
"""
...
from models.text_encoder import TextEncoder768, PosteriorEncoder
...
class SynthesizerTrnMs768NSFsid(nn.Module):
    """
    RVC v2 Synthesizer with F0 (pitch) conditioning.
    Uses 768-dim HuBERT features extracted from layer 12.
    
    Architecture:
    - TextEncoder768: Encodes 768-dim HuBERT features to latent
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize v2 synthesizer with F0.
        ...
        # Text/content encoder for 768-dim features
...
class SynthesizerTrnMs768NSFsid_nono(nn.Module):
    """
    RVC v2 Synthesizer WITHOUT F0 conditioning.
    For models trained without pitch information.
    Uses 768-dim HuBERT features from layer 12.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize v2 synthesizer without F0.
